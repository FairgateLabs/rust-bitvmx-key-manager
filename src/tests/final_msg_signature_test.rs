...
mod tests {
    ...
    fn test_final_signature() -> Result<(), anyhow::Error> {
        ...
        let signature_1 =
            musig_1.get_aggregated_signature(&aggregated_pub_key_1, id, "message_1")?;
        let signature_2 =
            musig_2.get_aggregated_signature(&aggregated_pub_key_2, id2, "message_1")?;

        let verification_1 =
            musig_1.verify_final_signature(&"message_1", signature_1, aggregated_pub_key_1, id)?;

        let verification_2 =
            musig_2.verify_final_signature(&"message_1", signature_2, aggregated_pub_key_2, id2)?;
