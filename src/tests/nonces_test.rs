...
mod tests {
    ...
    fn test_get_nonces() -> Result<(), anyhow::Error> {
        ...
        musig.init_musig2(musig_id, participant_pubkeys.clone(), my_pubkey)?;
    ...
    fn test_add_nonces() -> Result<(), anyhow::Error> {
        ...
        musig.init_musig2(musig_id, participant_pubkeys.clone(), participant_2)?;
    ...
    fn test_nonce_generation() -> Result<(), anyhow::Error> {
        ...
        musig.init_musig2(other_musig_id, participant_pubkeys.clone(), participant_2)?;
